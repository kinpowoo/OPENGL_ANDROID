...
public class SquareCoor extends Shape {
    ...
    static final int COORDS_PER_VERTEX = 3;   //顶着色器的维度个数
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        //设置相机位置
        Matrix.setLookAtM(mViewMatrix, 0, 0f, 0f, 5.0f, 0f, 0f, 0f, 0f, 1f, 0.0f);
        //计算变换矩阵
